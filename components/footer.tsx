        ...
        <div className="flex flex-col items-center justify-between space-y-8 md:flex-row md:space-y-0">
          <div className="text-center md:text-left flex flex-col items-center md:items-start">
            ...
            {[ 
              ...
              "Phone: +918374283037",
              "Email: mohankumar.work12@gmail.com"
            ].map((text, index) => (
              <p
                key={index}
              ...
              >
                {text.startsWith('Phone:') ? (
                  <>Phone: <a href="tel:+918374283037" className="hover:underline hover:text-primary transition-colors duration-300">+918374283037</a></>
                ) : text.startsWith('Email:') ? (
                  <>Email: <a href="mailto:mohankumar.work12@gmail.com" className="hover:underline hover:text-primary transition-colors duration-300">mohankumar.work12@gmail.com</a></>
                ) : text}
              </p>
            ))}
          </div>
