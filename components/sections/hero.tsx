...
<motion.h2
  ...
  className="text-4xl mt-4 ml-20 md:text-5xl font-extrabold tracking-tight text-primary mb-6"
>
  Mohan Kumar
</motion.h2>
        <motion.h1
  ...
  animate={{ scale: 1, opacity: 1 }}
  transition={{ duration: 0.5 }}
  className="text-sm md:text-5xl font-bold mb-2"
>
  Full-Stack Developer | Web & Product Designer
</motion.h1>
