...
import mohan2 from "../../assets/mohan2.jpg";
...
const handleDownload = () => {
  const cvUrl = "/Mohan_Kumar_CV.pdf"; // Ensure this file is in the public folder
  const link = document.createElement("a");
  link.href = cvUrl;
  link.setAttribute("download", "Mohan_Kumar_CV.pdf"); // Ensures download
  ...
  return (
            ...
            >
              ...
              <AnimatePresence mode="wait">
                {showBio ? (
                  ...
                  >
                    Hi I am Mohan Kumar. I'm a passionate developer focused on creating beautiful and functional web experiences. 
    ...
    >
      ...
      Download CV
              ...
              <a href="mailto:mohankumar.work12@gmail.com">
      <button className="border-primary text-primary hover:bg-primary hover:text-primary-foreground border px-4 py-2 rounded-lg flex items-center">
        <FaEnvelope className="mr-2 h-4 w-4" />
        Contact Me
      </button>
    </a>
             {/* GitHub Button */}
<a href="https://github.com/mohankumar01012005" target="_blank" rel="noopener noreferrer">
...
{/* LinkedIn Button */}
<a href="https://www.linkedin.com/in/mohan-kumar-0386a4283/" target="_blank" rel="noopener noreferrer">
  <Button variant="ghost" size="icon" className="text-primary hover:bg-primary/20">
